...
| Plan | Title | Priority | Effort | Depends on | Status |
|------|-------|----------|--------|------------|--------|
| 007 | Support pages tell the truth + /fave/support | P1 | L | — (parallel-safe with 008) | DONE — executed 2026-08-19 on `feat/support-pages-truth`. Savely + Fingo namespaces rewritten from source-verified facts, `/fave/support` shipped with its own skin, 4 shell links unprefixed, dead "Help centre" cards gone. `pnpm verify` green, 21/21 e2e (12 smoke + 9 new). **Read the ground-truth corrections below before executing 009 or 011.** |
